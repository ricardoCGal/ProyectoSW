...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" >
                <img src="img/control1.png" alt="Logo" width="70" height="60" class="d-inline-block align-text-top">
            </a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav justify-content-center" >
              <li class="nav-item">
                <a class="btn btn-dark" aria-current="page" href="principal.php">Inicio  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
    ...
    <div class="contenedor-grid">
      <!--<div class="class-elem1">
      
      </div>-->
      <div class="inicio">
        <p>Bienvenido "<?= $usuarios['user']; ?>"</p>
      </div>  
