<?php
    ...
    if (isset($_SESSION['user_id'])) {
      ...
      // Obtenemos todas las publicaciones con la información de likes y dislikes, ordenadas por likes y dislikes
                    ...
                    <div class="col mb-4" >
                        ...
                        <div class="publicacion<?= $publicacion['tipo_visualizacion']; ?>">
                          ...
                          <div class="info-publicacion">
                            ...
                            <button onclick="likeDislike('like', <?= $publicacion_id; ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                            ...
                            <button onclick="likeDislike('dislike', <?= $publicacion_id; ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
                              ...
                              <p>Abrir publicacion para poder votar</p>
                            </div>
                          </div>
                      </div>
                    <?php endforeach; ?>
